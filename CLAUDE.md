...
- **Redesign `DealDetailPage` — 4-tab restructure + field link-able (nama sales/akun, `ProfileMiniView.jsx`) + Chatter (komentar+@mention+notifikasi, `InquiryChatter.jsx`)** (3 commit berurutan; 2 tabel baru `inquiry_comments`/`inquiry_comment_mentions` belum direkam migrasi/snapshot — TD-163; Chatter tanpa `showToast` — TD-164). Lihat `PROGRESS.md` 2026-07-31.
