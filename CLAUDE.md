...
- **Fase 1 `contacts` TUNTAS** (tab Kontak CRUD penuh + kunci `pic_*` ke kontak primary di 10 file CRM) **+ restrukturisasi menu CRM batch #2** (Pipeline & Approval Lead Pool jadi menu top-level). Lihat `PROGRESS.md` 2026-07-26.
