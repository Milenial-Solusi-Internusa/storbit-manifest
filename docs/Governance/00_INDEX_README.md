...
| `docs/Governance/09_ROADMAP.md` | Status modul, next up, keputusan struktur (Finance, Design System D1–D7), **Keputusan Terbuka #1–#62** (yang perlu keputusan Den; #60–#62 design system sudah terjawab semua) | Den (memutuskan); AI (tahu apa yang belum diputuskan) | Sebelum memulai fitur; saat menemukan hal yang butuh keputusan |
...
| **Kerja UI / styling / PDF** | `docs/Governance/06_UI_UX_FLOW.md` → `docs/Governance/02_RULES_GOVERNANCE.md §5` → `docs/DESIGN_SYSTEM_REFERENCE.md` (kit mana yang berlaku + angka persisnya; ⚠️ kebijakan sage BELUM tampak di halaman PRODUKSI mana pun — kit tunggal `src/kit/` di `main` masih KODE MATI; di branch Batch DS 2 (`feat/kit-ds2-adminkit`, menunggu review) 22 halaman admin/Foundation sudah memakainya; ikuti tabel §0 dan jangan impor `src/kit` di luar giliran Batch DS-nya — #61 FINAL, dikonfirmasi Den 20 Sep 2026: berhenti per halaman saat Batch DS-nya selesai) |
