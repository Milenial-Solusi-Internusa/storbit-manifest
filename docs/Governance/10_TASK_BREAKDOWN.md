...
- [ ] **H2. FASE 5 — payment/LUNAS** (setelah H1): modul pembayaran → status LUNAS. *(planned — TETAP belum dibangun; tabel `sp_payments` sudah ada sbg skema kosong-fungsi, dibuat bareng H1 di atas)*
