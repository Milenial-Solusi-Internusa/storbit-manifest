...
>
> **Diperbarui 2026-08-07 (RBAC hardening) — D1 sebagian terjawab (`has_permission()` dikonfirmasi orphan), +D0 (fix privilege escalation `user_roles`, DONE), +D4 (audit RLS/RBAC menyeluruh TD-173 — 19 tabel CRITICAL, belum dieksekusi).** Detail: §D di atas + `08_TECH_DEBT.md` TD-170…TD-174 + `PROGRESS.md` 2026-08-07.
>
