...
export const ACTION_TYPES = {
  ...
  CREATE_VENDOR_OFFER: 'CREATE_VENDOR_OFFER',
  UPDATE_VENDOR_OFFER: 'UPDATE_VENDOR_OFFER',
  DELETE_VENDOR_OFFER: 'DELETE_VENDOR_OFFER',
  MARK_PRF_QUOTED:     'MARK_PRF_QUOTED',
  SELECT_VENDOR_OFFER: 'SELECT_VENDOR_OFFER',
  CREATE_BNF_REPORT:   'CREATE_BNF_REPORT',
  UPDATE_BNF_REPORT:   'UPDATE_BNF_REPORT',
};
