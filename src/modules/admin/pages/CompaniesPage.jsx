...
export default function CompaniesPage({ onHome }) {
  ...
  return (
    <div style={{ fontFamily: FONT_BODY, color: INK }}>
      <PageHeader
        crumbs={[{ label: 'Foundation' }, { label: 'Master Data & Admin Settings', onClick: onHome }, { label: 'Companies' }]}
        title="Companies"
      ...
      <div className="rounded-2xl border overflow-hidden" style={{ background: SURFACE, borderColor: LINE }}>
        ...
        <div
          ...
          style={{ gridTemplateColumns: '90px 1fr 1fr 80px', borderColor: LINE, background: CREAM, color: MUTED }}
        >
          <div>Code</div>
          <div>Name</div>
          ...
          data.map((row, i) => {
            ...
            return (
              <div
                ...
                style={{ gridTemplateColumns: '90px 1fr 1fr 80px', borderColor: LINE, background: zebra }}
              ...
              >
                ...
                <div className="text-sm" style={{ color: INK_SOFT }}>
                  {row.business_focus || <span style={{ color: MUTED }}>—</span>}
                </div>
