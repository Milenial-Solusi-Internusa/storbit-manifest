...
// Read-only list view for ERP roles master data.
...
export default function RolesPage() {
  ...
  return (
    <div>
      <AdminPageHeader
        title="Roles"
        subtitle="Named permission sets, company-scoped. System roles cannot be modified."
      ...
      >
        ...
        {error ? (
          ...
          <EmptyState
            message={search ? 'No roles match your search.' : 'No roles found.'}
          />
        ) : (
          data.map((row) => (
            <div
            ...
            >
              ...
              <div>
                ...
                {row.description && (
                  <div className="text-xs mt-0.5 truncate max-w-[280px]" style={{ color: PASTEL.inkMute }}>
                    {row.description}
                  </div>
                )}
              </div>
              <div>
                {row.is_system_role ? (
                  ...
                  <span className="text-xs" style={{ color: PASTEL.inkMute }}>Custom</span>
                )}
              </div>
