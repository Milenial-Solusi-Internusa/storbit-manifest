...
import { isAllEntities as isAllEntitiesRole, isManagerOrAbove } from '../../lib/roles';
...
/* Gate toggle My/All = isManagerOrAbove() di src/lib/roles.js (berbasis roles.level,
   cermin RLS is_manager_or_above()) — bukan lagi daftar role lokal.
...
export default function InquiryListPage({ onAddInquiry, onSelectInquiry, showToast }) {
  ...
  // memeriksa semua baris user_roles. Helper isManagerOrAbove (src/lib/roles.js,
  // berbasis roles.level) — pola sama: CustomerDetailPage.jsx:722.
  const canScopeToggle = isManagerOrAbove(erpRoles);
  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', color: C.ink }}>
      ...
      <ListView
        ...
        filters={
          <>
            {/* Scope My/All — hanya manager ke atas (gate isManagerOrAbove, lihat komentar di atas).
